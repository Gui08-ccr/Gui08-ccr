...
Config.Language = {
	joining = "[MS STORE | PVP] Entrando...",
	connecting = "[MS STORE | PVP] Conectando...",
	err = "[MS STORE | PVP] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[MS STORE | PVP] Você foi desconectado por demorar demais na fila.",
	pos = "Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[MS STORE | PVP] Não foi possível adiciona-lo na fila.",
    wlonly = "[MS STORE | PVP] Você não está aprovado na whitelist.",
	banned = "[MS STORE | PVP] Seu passaporte foi revogado na cidade.",
	steam = "[MS STORE | PVP] Você precisa estar com a Steam aberta para conectar."
}
