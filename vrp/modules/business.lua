...
local function build_client_business(source)
	local user_id = vRP.getUserId(source)
	if user_id then
		--vRPclient._addMarker(source,23,-1082.13,-247.59,37.76-0.95,2,2,0.5,0,95,140,50,100)
		--vRP.setArea(source,"vRP:business",-1082.13,-247.59,37.76,2,2,business_enter,business_leave)
	end
end
