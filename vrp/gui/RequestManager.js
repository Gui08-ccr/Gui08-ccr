...
RequestManager.prototype.buildText = function(text, time) {
  return "<span>" + text + "<br> <span id=\"act\"><a><span id=\"text1\">Aceitar</span> <span class=\"yes\">Y</span></a><span id=\"time\">" + time + "</span><a><span id=\"text2\">Recusar</span> <span class=\"no\">U</span></a></span></span>";
}
