Citizen.CreateThread(function()
	AddTextEntry("FE_THDR_GTAO","MS STORE | PVP | discord.gg/FHRECPen5q")
	while true do
		...
		SetVehicleModelIsSuppressed(-150975354,true)
		SetVehicleModelIsSuppressed(-613725916,true)
		SetVehicleModelIsSuppressed(-307958377,true)
